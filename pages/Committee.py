...
with st.container():
    ...
    with main_col:
        ...
        render_org_row(
            ...
            "IVI.png", 
            """
            Universiti Kebangsaan Malaysia (UKM), established in 1970, is a premier national research university ranked among the top 126 globally and top 2 in Malaysia. Spanning a 2,500-acre campus, it hosts over 30,000 students and is a leader in multidisciplinary research with deep global partnerships. A key pillar of UKM’s innovation is the Institute of Visual Informatics (IVI), a world-class postgraduate hub specializing in AI, visual computing, and social informatics. IVI is dedicated to frontier research and human capital development, bridging the gap between academia and industry through strong collaborations with multinational corporations and government agencies. As a central force in intelligent business and international research, IVI serves as a vital academic anchor for ACCD’26.
            """,
            (target_id == "ukm")
        )
...
Harbin University of Commerce attaches great importance to practical teaching and cooperation with enterprises, and is committed to cultivating applied and multi-skilled talents. It is one of the distinctive business universities in Heilongjiang Province.
        ...
        render_org_row(
            ...
            "METDC.jpg",
            """
            MATRADE is Malaysia’s government agency responsible for promoting international trade. It supports Malaysian enterprises with:  
...
With a network of 300+ international experts, WRTO supports research travel standards development, international research travel base certification, international conferences and forums, consultancy for education, tourism, and government sectors, curriculum development, guide training, and cultural/nature exploration programmes
        ...
        render_org_row(
            ...
            "SEARCH.jpg",
            """
            SEARCH is an independent strategic intelligence platform that connects government, industry, and academia to drive regional growth. Based in Malaysia, we act as a vital bridge within the Regional Free Trade Network, fostering collaboration and evidence-based partnerships. By aligning public policy with private sector innovation and academic research, we co-create scalable solutions for complex challenges in economic development, digital innovation, education, and sustainability.
            """,
            (target_id == "search")
        )
...
########主席部分
st.markdown("<h3 style='text-align:center;'>Advisor</h3>", unsafe_allow_html=True)
...
with st.container():
    ...
    with main_col:
        ...
        with st.expander("Tan Sri Dato’ Sri Dr. Ng Yen Yen J.P., Former Minister, Malaysia", expanded=(target_speaker == "ng-yen-yen")):
...
#############顾问人员
st.markdown("<h3 style='text-align:center;'>Chairman</h3>", unsafe_allow_html=True)
...
with st.container():
    ...
    with main_col:
        ...
        with st.expander("Prof. Ir. Dr. Riza Sulaiman, Universiti Kebangsaan Malaysia", expanded=(target_speaker == "riza-sulaiman")):
...
with st.container():
    ...
    with main_col:
        ...
        with st.expander("Prof. Dr. Ming Lang Tseng, Asia University, Taiwan", expanded=(target_speaker == "ming-lang")):
        ...
        with st.expander("Prof. Dr. Ming K. Lim, University of Glasgow, United Kingdom", expanded=(target_speaker == "ming-lim")):
        ...
        with st.expander("Jamaluddin Ibrahim, Makiplago Holding Sdn Bhd", expanded=(target_speaker == "jamaluddin-ibrahim")):
        ...
        with st.expander("Prof. Ts. Dr. Mohd Helmi Ali, Universiti Kebangsaan Malaysia", expanded=(target_speaker == "helmi-ali")):
...
<td style="border:1px solid #ddd; padding:10px;">Director, Institute of Visual Informatics, Universiti Kebangsaan Malaysia (IVI-UKM)</td>
</tr>

<tr>
<td style="padding:10px; border:1px solid #ddd;">Co-Chairman</td>
<td style="border:1px solid #ddd; padding:10px;">Prof. Ts. Dr Mohd Helmi Ali</td>
<td style="border:1px solid #ddd; padding:10px;">Professor, Graduate School of Business, Universiti Kebangsaan Malaysia (GSB-UKM)</td>
</tr>
...
<td style="border:1px solid #ddd; padding:10px;">Chairman of Malaysia–China Higher Education Exchange Association (PPTMC)</td>
</tr>

<tr>
<td style="padding:10px; border:1px solid #ddd;">Co-Chairman</td>
<td style="border:1px solid #ddd; padding:10px;">Mr. Ian Neo Chee Hua</td>
<td style="border:1px solid #ddd; padding:10px;">Chief Executive Officer, Southeast Asia Research Centre (SEARCH)</td>
</tr>

<tr>
<td style="padding:10px; border:1px solid #ddd;">Co-Chairman</td>
<td style="border:1px solid #ddd; padding:10px;">TBC</td>
<td style="border:1px solid #ddd; padding:10px;">TBC</td>
</tr>
...
<td style="border:1px solid #ddd; padding:10px;">Deputy President of Malaysia–China Higher Education Exchange Association (PPTMC)</td>
</tr>

<tr>
<td style="padding:10px; border:1px solid #ddd;">Secretary 1</td>
<td style="border:1px solid #ddd; padding:10px;">Ms. Najiha</td>
<td style="border:1px solid #ddd; padding:10px;">Secretary of Malaysia–China Higher Education Exchange Association (PPTMC)</td>
</tr>

<tr>
<td style="padding:10px; border:1px solid #ddd;">Secretary 2</td>
<td style="border:1px solid #ddd; padding:10px;">Representative</td>
<td style="border:1px solid #ddd; padding:10px;">Representative of Harbin Normal University (HNU)</td>
</tr>

<tr>
<td style="padding:10px; border:1px solid #ddd;">Treasurer</td>
<td style="border:1px solid #ddd; padding:10px;">Datin Kuong Ivy</td>
<td style="border:1px solid #ddd; padding:10px;">Treasurer of Malaysia–China Higher Education Exchange Association (PPTMC)</td>
</tr>
...
Ms. Chen Chu Chu (Vice Chairman of Malaysia–China Higher Education Exchange Association, PPTMC) </br>
Ms. Melissa Ma Zhou Qun (Vice Chairman of Malaysia–China Higher Education Exchange Association, PPTMC) </br>
Dr. Diana Liang Xin Rui (Secretary of Malaysia–China Higher Education Exchange Association, PPTMC) </br>
Dr. Zoul Liu Zong Yi (Secretary of Malaysia–China Higher Education Exchange Association, PPTMC) </br>
Ms. Ivvy Teh  (Committee of Malaysia–China Higher Education Exchange Association, PPTMC ) </br>
Representative of UKM IVI</br>
Representative of Universiti Putra Malaysia</br>
Representative of Harbin Normal University</br>
Representative of Harbin Normal University</br>
Representative of Harbin University of Commerce</br>
</td>
</tr>
